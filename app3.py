...
st.markdown(
    ...
    <style>
    /* ─── TABELAS ─── */
    table.dataframe, table.rendered_html {
        width: 100% !important;
    ...
    /* Cabeçalho */
    .dataframe thead th, .rendered_html thead th {
    ...
    /* Números alinhados à direita para leitura rápida */
    .dataframe td:not(:first-child), .rendered_html td:not(:first-child) {
        text-align: right !important;
    }

    /* Hover de linha */
    .dataframe tbody tr:hover td, .rendered_html tbody tr:hover td {
        background-color: #1c2128 !important;
    }

    /* Badges de valor (use em vez de colorir a linha inteira) */
    .val-up   { color: #3fb950 !important; font-weight: 600; }
    .val-down { color: #f85149 !important; font-weight: 600; }
    .val-neutral { color: #e6edf3 !important; }
    </style>
    """,
